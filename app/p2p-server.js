const WebSocket = require('ws'); //Web Socket Module

const P2P_PORT = process.env.P2P_PORT || 5001; //Declare the Ports for Peers


const peers = process.env.PEERS ? process.env.PEERS.split(',') : []; //list of address to connect to
...
class P2pserver{
    ...
    transactionBroadC(transaction){
         this.sockets.forEach(socket =>{
             this.sendTransaction(socket,transaction);
         });
     }

    clearTransactionsBroadC(){
        this.sockets.forEach(socket => {
