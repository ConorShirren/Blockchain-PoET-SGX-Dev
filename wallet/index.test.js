...
describe('Wallet',()=>{
    ...
    describe('calculating the balance',()=>{
        ...
        beforeEach(()=>{
            ...
            blockchain.addBlockToChain(transactionPool.transactions);
        });

        it('calculates the balance for the blockchain transactions matching the recipient',()=>{
            expect(wallet.calculateBalance(blockchain)).toEqual(initBAL + (addBalance*repeatAdd));
        })

        it('calculates the balance for the blockchain transactions matching the sender',()=>{
            expect(senderWallet.calculateBalance(blockchain)).toEqual(initBAL - (addBalance*repeatAdd));
        })
