...
const { initBAL } = require('../config.js');
...
class Wallet {
    constructor(){  
        this.balance = initBAL;                                 // Initial Balance 
        this.keyPair = Util.genKeyPair();                       // Generate Key Pair for Wallet
        this.publicKey = this.keyPair.getPublic(true,'hex');    // Retreive Public Key
    }  

    toString(){ //Print the wallet to the console
        return `Wallet - 
